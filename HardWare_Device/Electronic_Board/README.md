# Electronic Board
## Design Overview
The Air Quality Monitoring PCB is a custom-designed electronic board for the Breathe Node prototype, built around the ESP32-WROOM-32UE microcontroller.
...
The PCB is powered via a standard conector for 9V or 12V input, with onboard regulation to 3.3V for the ESP32 and 5V for the Sensors.
