"""
OneDevice
This code simulates the function or prototype
...
url = "https://breathe-nasa-space-apps-2025.onrender.com/cookie_hardware/004" #This IP is specific for the sensor
...
counter_time=600 #time in seconds to wait until the next post 10min
